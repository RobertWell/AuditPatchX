...
class TableResourceTest {
    ...
    inner class GetByPkTests {
        ...
        fun testGetByPk() {
            ...
            given()
                .contentType(ContentType.JSON)
                .body(request)
                .`when`().post("/api/tables/record/get")
                .then()
                .statusCode(200)
    ...
    inner class ValidatePatchTests {
        ...
        fun testValidateValidPatch() {
            ...
            given()
                .contentType(ContentType.JSON)
                .body(request)
                .`when`().post("/api/tables/record/validate-patch")
                .then()
                .statusCode(200)
    ...
    inner class UpdateTests {
        ...
        fun testUpdateEmployeeSalary() {
            ...
            given()
                .contentType(ContentType.JSON)
                .body(request)
                .`when`().post("/api/tables/record/update")
                .then()
                .statusCode(200)
    ...
    inner class GetMetadataTests {
        ...
        fun testGetEmployeeMetadata() {
            given()
                .`when`().get("/api/tables/db/tables/TESTUSER/EMPLOYEE")
                .then()
                .statusCode(200)
        ...
        fun testGetDepartmentMetadata() {
            given()
                .`when`().get("/api/tables/db/tables/TESTUSER/DEPARTMENT")
                .then()
                .statusCode(200)
        ...
        fun testGetMetadataCompositePk() {
            given()
                .`when`().get("/api/tables/db/tables/TESTUSER/JOB_HISTORY")
                .then()
                .statusCode(200)
        ...
        fun testGetMetadataUnauthorizedTable() {
            given()
                .`when`().get("/api/tables/db/tables/TESTUSER/UNAUTHORIZED_TABLE")
                .then()
                .statusCode(403)
                .body("error", equalTo("Access denied"))
        }
